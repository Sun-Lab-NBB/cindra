...
def _make_mask(y_pixels, x_pixels, weights, frame_width, centroid=None, radius=5.0, cluster_id=0):
...
class TestCreateTemplateRoi:
    ...
    def test_no_surviving_pixels(self):
...
class TestClusterRoisInBin:
    ...
    def test_identical_rois_from_different_recordings(self):
    ...
    def test_distant_rois_not_clustered(self):
    ...
    def test_same_recording_not_clustered(self):
...
class TestFilterTemplates:
    ...
    def test_keeps_large_masks(self):
    ...
    def test_removes_small_masks(self):
    ...
    def test_none_overlap_mask_kept(self):
