...
class TestScaleSpacePyramid:
    ...
    def test_base_level_created(self):
    ...
    def test_min_scale_zero_preserves_data(self):
    ...
    def test_get_scale_at_base_level(self):
    ...
    def test_get_scale_adds_levels(self):
    ...
    def test_get_scale_returns_finite(self):
    ...
    def test_min_scale_with_downsampling(self):
    ...
    def test_small_min_scale_no_downsampling(self):
