...
class TestDiffeomorphicDemonsRegistration:
    ...
    def test_constructor_stores_images(self):
    ...
    def test_compute_grid_sampling(self):
    ...
    def test_cache_stale_key_returns_none(self):
    ...
    def test_register_identical_images(self):
    ...
    def test_register_produces_deformations(self):
