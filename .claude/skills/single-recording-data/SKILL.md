---
name: single-recording-data
description: >-
  Complete reference for single-recording pipeline configuration parameters and data formats. Documents all 9
  configuration sections, parameter meanings, default values, input data format, acquisition parameter handling,
  and detailed output data reference covering every file generated by the pipeline. Use when configuring single-recording
  processing, when the user asks about single-recording configuration parameters, or when the user asks about single-recording
  input or output data.
user-invocable: true
---

# Single-recording configuration and data reference

Complete parameter reference and data format documentation for the single-recording (within-recording) cindra processing
pipeline.
...
- Pipeline-set parameters and multi-recording compatibility requirements
- Complete output data reference: every file, directory, array shape, dtype, and NPZ key produced by the pipeline

**Does not cover:**
- Multi-recording configuration parameters or data formats (see `/multi-recording-data`)
- Processing workflow, recording discovery, or batch operations (see `/single-recording-processing`)
- Multi-recording processing workflow or ROI tracking (see `/multi-recording-processing`)
...
| Skill                          | Relationship                                                                      |
|--------------------------------|-----------------------------------------------------------------------------------|
| `/multi-recording-data`        | Companion configuration and data reference for the multi-recording pipeline       |
