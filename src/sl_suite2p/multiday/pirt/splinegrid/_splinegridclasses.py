...
class FieldDescription:
    ...
    Describes the dimensions of a field. It stores
    ...
    (e.g. SplineGrid and Deformation instances).
    ...
    def __init__(self, shape, sampling=None, origin=None):
        ...
        elif hasattr(shape, "field_shape") and isinstance(shape.field_shape, (list, tuple)):
...
class GridInterface:
    ...
    Parameters
    ----------
    field : shape-tuple, numpy-array, or FieldDescription
    ...
    def __init__(self, field, sampling):
        ...
        # Check field
        if isinstance(field, FieldDescription) or hasattr(field, "sampling"):
            ...
            raise ValueError("field should be a numpy array or shape-tuple.")
    ...
    def refine(self):
        ...
        if isinstance(self, GridContainer):
            ...
            # Apply calculated knots, crop if necessary for 2D
    ...
    def add(self, other_grid):
        ...
        # Check
        if not (
            self.field_shape == other_grid.field_shape and self.field_sampling == other_grid.field_sampling
        ):  # nocov
...
class GridContainer(GridInterface):
    ...
    def __getitem__(self, item):
        ...
        raise IndexError("GridContainer only supports integer indices.")
...
class SplineGrid(GridInterface):
    ...
    Parameters
    ----------
    field : shape-tuple, numpy-array, FieldDescription
        A description of the field that this grid applies to.
        The field itself is not stored, only the field's shape and
        sampling are of interest.
    sampling : number
    ...
    Limitations
    -----------
    This implementation only supports 2D grids.
    ...
    def __init__(self, *args, **kwargs):
        ...
        # when used in a SplineGridHelper
        self._thisDim = 0
    ...
    def get_field(self):
        ...
        """
        return _splinegridfuncs.get_field(self)
    ...
    def _refine(self, knots):
        ...
        """
        # For each dimension (2D only), refine the grid with a factor of two
