...
SUPPORTED_INPUT = ["tiff", "raw", "mesoscan", "binary"]
...
class IOData:
    ...
    ops_path: str | Path
    """The absolute path to the ops.npy file for each plane."""
    ...
    mean_image_channel_2: NDArray[np.float32]
