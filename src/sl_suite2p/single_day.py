...
def resolve_parameters(configuration: SingleDayS2PConfiguration) -> Path:
    ...
    # Generates and returns the path to a 'single_day_ss2p_configuration.yaml' file.
    config_file_path = save_folder.joinpath("single_day_s2p_configuration.yaml")
    resolved_config.to_config(file_path=config_file_path)
