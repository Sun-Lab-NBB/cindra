...
from ..layout import TRACKING_TEMPLATE_MASKS_FILENAME as TRACKING_TEMPLATE_MASKS_FILENAME
...
def _count_shared_pixels(first_pixels: NDArray[np.int32], second_pixels: NDArray[np.int32]) -> int: ...
