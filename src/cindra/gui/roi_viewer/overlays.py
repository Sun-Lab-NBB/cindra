"""Provides background view construction and ROI overlay rendering for the ROI viewer."""
...
from .data_models import ColorArrays, ColorbarWidgets, ROIIndexMaps
...
def compute_colors(
    ...
    color_count = len(CONFIG.color_names)
