...
class Registration:
    ...
    overrides batch_size on that path, where the device memory budget bounds the batch instead of the host RAM budget.
    Setting this to 0 uses batch_size on the device as well."""
