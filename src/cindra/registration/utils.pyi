...
def _normalize_frame_spectra(spectra: NDArray[np.complex64], kernel: NDArray[np.complex64]) -> None: ...
def _normalize_block_spectra(spectra: NDArray[np.complex64], kernel: NDArray[np.complex64]) -> None: ...
