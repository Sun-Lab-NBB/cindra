...
MINIMUM_KNOTS_FOR_FROZEN_EDGES: int
...
def _compute_basis_coefficients(interpolation_factor: float, coefficients: NDArray[np.float32]) -> None: ...
def _compute_basis_matrices(
    extent: int, grid_sampling: float, knot_count: int
